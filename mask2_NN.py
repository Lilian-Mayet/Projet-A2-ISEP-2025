...
BASE_MASK_DIR_ROOT = 'R_BIN2/R_BIN2' 
...
MODEL_SAVE_PATH = 'oct_segmentation_mask_2.keras'
...
def load_dataset(base_img_dir, base_mask_dir, nn_target_h, nn_target_w):
    ...
    for patient_folder in patient_folders:
        ...
        for img_path in img_files:
            ...
            mask_path = os.path.join(mask_folder_path, base_filename[:-4]+"_BIN2.png")
